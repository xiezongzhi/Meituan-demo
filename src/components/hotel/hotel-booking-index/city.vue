			...
			<div class="cityBox">
				...
				<div class="s-type">
					...
					<div class="type-item box">
						<ul class="table">
							<li v-for="item in placeRecord" @click.stop="selected(item)">
				...
				<div class="s-type">
					...
					<div class="type-item box">
						<ul class="table">
							<li >
								<a href="javascript:" @click.stop="ccc($event)">珠海</a>
							</li>
							<li>
								<a href="javascript:" @click.stop="ccc($event)">广州</a>
							</li>
							<li>
								<a href="javascript:" @click.stop="ccc($event)">上海</a>
							</li>
							<li>
								<a href="javascript:" @click.stop="ccc($event)">深圳</a>
							</li>
						</ul>
					</div>
				</div>
				<div class="s-type">
					...
					<div class="type-item box charlist">
						<ul class="table">
							<li v-for="(letter,index) in letters" @click.stop="seleccity(index)" >
					...
					<div class="type-item box all-city" v-for="cityItem in cityList">
						<ul class="table">
							...
							<li v-for="cityname in cityItem.list" @click.stop="selected(cityname)">
								<a href="javascript:;" >{{cityname}}</a>
							</li>
						</ul>
					</div>
	...
	export default{
		...
		methods:{
	        ...
	        selected(city){
	        	...
	        	let history = getStore('placerecord1');
                ...
                setStore('placerecord1',this.placeRecord)
	        	this.$emit('hideCity', city)
	        },
	        getCity(){//获取城市列表
	        ...
	        initRecord(){
	        	if (getStore('placerecord1')) {
                    this.placeRecord = JSON.parse(getStore('placerecord1'));
                }else{
